...
1. Clone or symlink this repo to your config:
   ...
   Start Neovim. The plugin manager (lazy.nvim) will bootstrap and install plugins.
   ```

Install language servers & debuggers via Mason:
...
Copy code
:TSUpdate
(Python) Activate your project venv before opening nvim, or let pyright auto-detect if .venv/bin/python exists at repo root.
